...
NebulaOS is a web-based operating system designed to mimic a customized ("riced") Linux environment. It features draggable applications, a notification menu, a local media player, and a system settings flyout/dropdown.
